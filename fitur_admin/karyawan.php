            ...
            <tbody>
                <?php foreach($pegawai as $data){ ?>
                    <tr>
                        ...
                        <td><?= $data['status'] ?></td>
                        <td>
                            <a href="?hal=info&id=<?= $data['nip'] ?>" role="button" class="btn btn-primary info">Info</a>
                            <a href="?hal=profile_edit&id=<?= $data['nip'] ?>" role="button" class="btn btn-warning info">Edit</a>
                            <a href="delete.php?id=<?= $data['nip'] ?>" role="button" class="btn btn-danger info">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
